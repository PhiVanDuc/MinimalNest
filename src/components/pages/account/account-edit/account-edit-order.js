...
export default function AccountEditOrder() {
    return (
        <div className="w-[40%] py-[20px] rounded-[10px] bg-white space-y-[20px]">
            <div className="px-[20px] flex items-center gap-[20px] pb-[20px] border-b">
                <p className="text-[14px] font-medium text-darkMedium">Tài khoản đã hoàn thành <span className="text-yellowBold font-semibold">10</span> đơn hàng.</p>
            </div>
                        ...
                        Array.from({ length: 10 }).map((_, index) => {
                            return (
                                <AccordionItem
                                    ...
                                    value={`item-${index + 1}`}
                                >
                                    <AccordionTrigger className="px-[16px] py-[16px] rounded-[10px] border">
                                        Đơn hàng: {index + 1}
                                    </AccordionTrigger>
