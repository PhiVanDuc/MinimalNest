...
export default function PaymentCoupon() {
    return (
        <div className="rounded-[10px] border p-[20px] space-y-[30px]">
            <header className="flex flex-col sm:flex-row items-center justify-between gap-[20px]">
            ...
            {/* <div className="space-y-[15px]">
                <div className="rounded-[10px] bg-white flex items-center gap-[15px] cursor-pointer">
                    <div className="shrink-0 w-[80px] aspect-square rounded-[10px] bg-slate-200" />
                    ...
                    <div className="w-full flex items-center justify-between gap-[20px]">
                        <div className="space-y-[5px]">
                            ...
                            <p className="truncate-2 text-[13px] sm:text-[14px] font-semibold text-darkBold">Voucher Độc Quyền – Nhận Ngay Ưu Đãi Chưa Từng Có</p>
